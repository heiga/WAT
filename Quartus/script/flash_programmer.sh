...
#
nios2-flash-programmer "../flash/ECE492_g7_2017w_WAT_epcs_flash_controller_0.flash" --base=0x1009000 --epcs --sidp=0x100A100 --id=0x0 --timestamp=1490659031 --device=1 --instance=0 '--cable=USB-Blaster on localhost [USB-0]' --program --erase-all 
...
#
nios2-flash-programmer "../flash/WAT_MAIN_epcs_flash_controller_0.flash" --base=0x1009000 --epcs --sidp=0x100A100 --id=0x0 --timestamp=1490659031 --device=1 --instance=0 '--cable=USB-Blaster on localhost [USB-0]' --program 
