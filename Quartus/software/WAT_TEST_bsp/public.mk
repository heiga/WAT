...
# setting SOPC_SYSID_BASE_ADDRESS is 0x100a0e0
SOPC_SYSID_FLAG += --sidp=0x100a0e0
ELF_PATCH_FLAG  += --sidp 0x100a0e0

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1487814232
SOPC_SYSID_FLAG += --timestamp=1487814232
ELF_PATCH_FLAG  += --timestamp 1487814232
