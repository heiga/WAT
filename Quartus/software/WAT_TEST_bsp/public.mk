...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../trolley_system.sopcinfo
...
# Design Name 
# setting SOPC_NAME is trolley_system
SOPC_NAME := trolley_system
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x100a100
SOPC_SYSID_FLAG += --sidp=0x100a100
ELF_PATCH_FLAG  += --sidp 0x100a100

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1490494299
SOPC_SYSID_FLAG += --timestamp=1490494299
ELF_PATCH_FLAG  += --timestamp 1490494299
...
# Small-footprint (polled mode) driver none 
# setting fifoed_avalon_uart_driver.enable_small_driver is false
